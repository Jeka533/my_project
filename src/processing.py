...
def sort_by_date(transactions: List[Dict[str, Any]], is_reverse: bool = True) -> List[Dict[str, Any]]:
    """
    Сортирует список словарей по дате.
    """
    return sorted(transactions, key=lambda x: x["date"], reverse=is_reverse)
